...
Blockly.Msg.KF_ARCADEPHYSICS_GET_COLLISIONS_CAN_TOOLTIP = "Can this gameobject be touched on the selected side? 'Any' means one or more sides. Collisions must be enabled.";  // untranslated
...
Blockly.Msg.KF_ARCADEPHYSICS_GET_COLLISIONS_TOOLTIP = "Is this gameobject touching on the selected side? 'Any' means one or more sides. Collisions must be enabled.";  // untranslated
Blockly.Msg.KF_ARCADEPHYSICS_GET_COLLISIONS_WAS_TOOLTIP = "Was this gameobject touching on the selected side last frame? 'Any' means one or more sides. Collisions must be enabled.";  // untranslated
...
Blockly.Msg.KF_DEVICE_COCOON_MESSAGE = "running on mobile?";  // untranslated
Blockly.Msg.KF_DEVICE_COCOON_TOOLTIP = "TRUE if the game is running in mobile mode. Mobile mode is set when you use Playtest On Mobile or create a Cocoon build. Mobile devices do not have keyboards, so use this block to set up alternate control schemes.";  // untranslated
...
Blockly.Msg.KF_EVENT_KEY_INPUT_MESSAGE = "When";  // untranslated
...
Blockly.Msg.KF_EVENT_MESSAGE_MESSAGE_BEFORE = "When I receive";  // untranslated
Blockly.Msg.KF_EVENT_MESSAGE_TOOLTIP = "Run the enclosed code when the specified message is received. Useful for passing commands between game objects.";  // untranslated
Blockly.Msg.KF_EVENT_MESSAGE_VALUE_HELPURL = "";  // untranslated
Blockly.Msg.KF_EVENT_MESSAGE_VALUE_MESSAGE_ONE = "When I receive";  // untranslated
Blockly.Msg.KF_EVENT_MESSAGE_VALUE_MESSAGE_TWO = "with a";  // untranslated
Blockly.Msg.KF_EVENT_MESSAGE_VALUE_TOOLTIP = "Run the enclosed code when the specified message is received. If a value was passed along with the message, it is stored in a variable. Useful for passing commands and data between game objects.";  // untranslated
...
Blockly.Msg.KF_GAME_GOTO_URL_HELPURL = "";  // untranslated
Blockly.Msg.KF_GAME_GOTO_URL_MESSAGE = "go to URL";  // untranslated
Blockly.Msg.KF_GAME_GOTO_URL_TOOLTIP = "Prompt the user to navigate to the specified URL.";  // untranslated
...
Blockly.Msg.KF_GAME_STAGE_GET_COLOUR_MESSAGE = "background colour";  // untranslated
...
Blockly.Msg.KF_GAME_STAGE_SET_COLOUR_MESSAGE = "set background colour to";  // untranslated
...
Blockly.Msg.KF_INPUT_KEY_DOWN_HELPURL = "";  // untranslated
Blockly.Msg.KF_INPUT_KEY_DOWN_MESSAGE1 = "key";  // untranslated
Blockly.Msg.KF_INPUT_KEY_DOWN_MESSAGE2 = "pressed?";  // untranslated
Blockly.Msg.KF_INPUT_KEY_DOWN_TOOLTIP = "Is the specified key down?";  // untranslated
...
Blockly.Msg.KF_KEY_SPECIAL_TOOLTIP = "A keyboard key. These are not letters, but actual keys. For example, + and = are the same key. Not all keyboards may have all keys.";  // untranslated
...
Blockly.Msg.KF_MESSAGING_CLASS_MESSAGE_BEFORE = "send";  // untranslated
Blockly.Msg.KF_MESSAGING_CLASS_TOOLTIP = "Send a message to all instances of a class you pass.";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_HELPURL = "";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_MESSAGE = "broadcast";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_TOOLTIP = "Send a message to every gameobject.";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_VALUE_HELPURL = "";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_VALUE_MESSAGE_ONE = "broadcast";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_VALUE_MESSAGE_TWO = "with";  // untranslated
Blockly.Msg.KF_MESSAGING_EVERYONE_VALUE_TOOLTIP = "Send a message to every gameobject along with a value.";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_HELPURL = "";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_MESSAGE_AFTER = "to";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_MESSAGE_BEFORE = "send";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_TOOLTIP = "Send a message to another game object.";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_VALUE_HELPURL = "";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_VALUE_MESSAGE_ONE = "send";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_VALUE_MESSAGE_THREE = "with";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_VALUE_MESSAGE_TWO = "to";  // untranslated
Blockly.Msg.KF_MESSAGING_INSTANCE_VALUE_TOOLTIP = "Send a message to an instance along with a value.";  // untranslated
...
Blockly.Msg.KF_MESSAGING_LIST_MESSAGE_BEFORE = "send";  // untranslated
Blockly.Msg.KF_MESSAGING_LIST_TOOLTIP = "Send a message to every instance in a list.";  // untranslated
...
Blockly.Msg.KF_PRIMITIVES_CREATE_CIRCLE_TOOLTIP = "Creates a new circle object with a radius that you set.";  // untranslated
...
Blockly.Msg.KF_PRIMITIVES_CREATE_LINE_TOOLTIP = "Creates a new line object from the transforms origin to a point in space.";  // untranslated
...
Blockly.Msg.KF_PRIMITIVES_CREATE_RECTANGLE_TOOLTIP = "Creates a new rectangle object with a width and height that you set.";  // untranslated
...
Blockly.Msg.KF_PRIMITIVES_CREATE_STAR_TOOLTIP = "Creates a new star object with a specified number of points.";  // untranslated
...
Blockly.Msg.KF_SCRATCH_CONTROL_FOREVER_FRAMES_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_CONTROL_FOREVER_FRAMES_MESSAGE1 = "forever";  // untranslated
Blockly.Msg.KF_SCRATCH_CONTROL_FOREVER_FRAMES_TOOLTIP = "Run the code inside this block forever. The first run happens immediately. Subsequent runs occur on subsequent game frames.";  // untranslated
Blockly.Msg.KF_SCRATCH_CONTROL_REPEAT_FRAMES_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_CONTROL_REPEAT_FRAMES_MESSAGE1 = "repeat";  // untranslated
Blockly.Msg.KF_SCRATCH_CONTROL_REPEAT_FRAMES_TOOLTIP = "Run the code inside this block this many times. The first run happens immediately. Subsequent runs occur on subsequent game frames.";  // untranslated
Blockly.Msg.KF_SCRATCH_EVENTS_WAIT_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_EVENTS_WAIT_MESSAGE1 = "wait";  // untranslated
Blockly.Msg.KF_SCRATCH_EVENTS_WAIT_MESSAGE2 = "seconds";  // untranslated
Blockly.Msg.KF_SCRATCH_EVENTS_WAIT_TOOLTIP = "Wait before running the code inside this block. Code after this block will run right away.";  // untranslated
Blockly.Msg.KF_SCRATCH_GO_TO_XY_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_GO_TO_XY_MESSAGE_ONE = "go to x ";  // untranslated
Blockly.Msg.KF_SCRATCH_GO_TO_XY_MESSAGE_TWO = "y";  // untranslated
Blockly.Msg.KF_SCRATCH_GO_TO_XY_TOOLTIP = "Move this object to the position specified by x and y.";  // untranslated
Blockly.Msg.KF_SCRATCH_MOVE_STEPS_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_MOVE_STEPS_MESSAGE_AFTER = "steps";  // untranslated
Blockly.Msg.KF_SCRATCH_MOVE_STEPS_MESSAGE_BEFORE = "move";  // untranslated
Blockly.Msg.KF_SCRATCH_MOVE_STEPS_TOOLTIP = "Move this object by the specified value in the direction of its current rotation.";  // untranslated
Blockly.Msg.KF_SCRATCH_POINT_DIRECTION_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_POINT_DIRECTION_MESSAGE = "point in direction";  // untranslated
Blockly.Msg.KF_SCRATCH_POINT_DIRECTION_TOOLTIP = "Rotate this object so that it points in the specified direction.";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_LEFT_BY_DEGREE_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_LEFT_BY_DEGREE_MESSAGE_AFTER = "to the left";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_LEFT_BY_DEGREE_MESSAGE_BEFORE = "turn ";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_LEFT_BY_DEGREE_TOOLTIP = "Turn the object to the left by this many degrees.";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_RIGHT_BY_DEGREE_HELPURL = "";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_RIGHT_BY_DEGREE_MESSAGE_AFTER = "to the right";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_RIGHT_BY_DEGREE_MESSAGE_BEFORE = "turn ";  // untranslated
Blockly.Msg.KF_SCRATCH_TURN_RIGHT_BY_DEGREE_TOOLTIP = "Turn the object to the right by this many degrees.";  // untranslated
...
Blockly.Msg.KF_WRITE_MSG = "write";  // untranslated
Blockly.Msg.KF_WRITE_TOOLTIP = "Used to log a message in the console and to display it on the debug screen.";  // untranslated
Blockly.Msg.KF_WRITE_URL = "";  // untranslated
Blockly.Msg.KIWI_CAMERA_SHAKE_OFFSET_HELPURL = "";  // untranslated
Blockly.Msg.KIWI_CAMERA_SHAKE_OFFSET_MESSAGE1 = "shake camera";  // untranslated
Blockly.Msg.KIWI_CAMERA_SHAKE_OFFSET_MESSAGE_AMP = "pixels over";  // untranslated
Blockly.Msg.KIWI_CAMERA_SHAKE_OFFSET_MESSAGE_DUR = "seconds";  // untranslated
Blockly.Msg.KIWI_CAMERA_SHAKE_OFFSET_TOOLTIP = "Shake the camera by wobbling its offset values for a duration (in seconds). Who knows what might happen if you edit the offset during the shake?";  // untranslated
Blockly.Msg.KIWI_INSTANCE_CENTER_ANCHOR_POINT_MSG = "center anchor point of";  // untranslated
Blockly.Msg.KIWI_INSTANCE_CENTER_ANCHOR_POINT_TOOLTIP = "Set the anchor point/pivot of an instance to its center.";  // untranslated
Blockly.Msg.KIWI_MECHANICS_EASING_HELPURL = "";  // untranslated
Blockly.Msg.KIWI_MECHANICS_EASING_MESSAGE1 = "ease";  // untranslated
Blockly.Msg.KIWI_MECHANICS_EASING_MESSAGE2 = "using";  // untranslated
Blockly.Msg.KIWI_MECHANICS_EASING_TOOLTIP = "Apply easing to a number from 0-1. Easing smooths out linear transitions and interpolations: it can make things start and/or stop smoothly, or create other cool effects. Useful in tweens.";  // untranslated
